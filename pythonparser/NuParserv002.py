...
blk01 = "/root/.nu/testnet/blk0001.dat"
blk02 = "/root/.nu/testnet/blk0002.dat"
blk   = ""
...
orphanList = []
officialList = []
onehundredblock = computeBlockHash(wed[len(wed)-101][8:168])
twohundredblock = computeBlockHash(wed[len(wed)-201][8:168])
...
if bSearch == 0:
    ...
    if bTwoSearch == 0:
        ...
        print "two hundred block was found"
else:
    ...
    print "one hundred block was found."
    for each in xrange(len(wed)-1,len(wed)-101,-1):
                ...
                if outScriptLen == "00":
                    ...
                    if each[counter+18:counter+22] == "6a51": #the script length is less than 255 bytes
                        ...
                        if each[counter+30:counter+38]=="01000000":
                            ...
                            #WITH PUSH STACK BYTE. 409c represents 40,000 //version 0.4.0 
                            #this needs to be changed when new builds are available
