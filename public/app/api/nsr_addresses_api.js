var db = require('mongojs').connect('mongodb://<username>:<password>@127.0.0.1:27017/BlockDB',['BlockCollection', 'SharesAddressCollection', 'StatusCollection', 'TxCollection' ]);
